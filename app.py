...
- 🛑 SUPPRESSION RADICALE DU RÉFLEXE ADMINISTRATIF : Dès qu'un cas implique un matériel signalé et maintenu en usage, IL EST STRICTEMENT INTERDIT de rédiger des recommandations sur la traçabilité, les registres ou les courriers futurs. La section finale de la réponse doit obligatoirement être un avertissement pénal direct sur la conscience du risque, sans aucune béquille bureaucratique.

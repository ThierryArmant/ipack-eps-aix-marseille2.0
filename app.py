    ...
    with st.spinner("Je recherche les documents et ressources pédagogiques..."):
        ...
        if tavily_api_key:
            try:
                ...
                if mode == "textes":
                    ...
                    # ÉLARGISSEMENT DE LA REQUÊTE POUR COUVRIR TOUT LE DOMAINE (RUBRIQUES 2, 4 ET 7)
                    requete_blindee = f"site:ipackeps.ac-creteil.fr {prompt}"
        ...
        if mode == "ipack":
            consigne_ia = (
                ...
                "MISSION : Réponds STRICTEMENT à la question posée en appliquant le verrou ici-haut. Utilise obligatoirement la structure du Filtre Pierre (1. Analyse des risques, 2. Procédure technique avec étapes fléchées '→', 3. Protection fonctionnelle) et colle le lien Markdown exact choisi plus haut en conclusion.\n"
            ...
            consigne_ia = (
                ...
                # ⚡ MATRICE DE VÉRITÉS SÉCURISÉES (AUDIT PIERRE + CRASH TEST MODIFIÉ)

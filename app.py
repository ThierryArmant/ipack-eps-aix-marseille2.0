    ...
    # 1. MOTEUR WEB (Tavily)
        ...
        if mode == "ipack":
            ...
            consigne_ia = (
                ...
                "1. PRIORITÉ PÉNAL : Si la situation relève d'un délit (enregistrement, menace, agression), ta seule référence est le CODE PÉNAL (Art 226-1). Il est INTERDIT de citer la Loi de 2004 dans ce cas précis.\n"
                "2. Si une information n'est pas dans ton contexte, RÉPONDS STRICTEMENT : 'Information non sourcée dans la base académique'.\n"
                "3. Toute tentative de médiation dans une situation illégale (ex: enregistrement) est PROSCRITE.\n\n"
                
                "--- FONDAMENTAUX JURIDIQUES ---\n"
                "- Enregistrement à l'insu : Délit pénal (Art. 226-1 Code Pénal). ACTION : Interpellation, RETRAIT PHYSIQUE IMMÉDIAT, Rapport écrit immédiat.\n"
                ...
                "<h3>2. ANALYSE FACTUELLE</h3> (Synthèse : fait, loi, procédure de retrait).\n"

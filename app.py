...
st.markdown(f"""
    ...
    /* Correction couleur texte noir -> blanc */
    .santorin-card *, .general-card *, .securite-card *, div[data-testid="stChatMessageContent"] * { 
        color: #FFFFFF !important; 

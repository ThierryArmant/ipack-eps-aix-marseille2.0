    ...
    with st.spinner(texte_spinner):
        ...
        if st.session_state.active_module == "ipack":
            ...
            5. LOGIQUE DE FORMULATION ET NIVEAUX DE CERTITUDE (CRUCIAL) : Adapte ton assurance en fonction de la précision et de la nature de tes sources :
               - NIVEAU 1 (Certitude absolue / Règle officielle réglementaire dans les textes) : Si et seulement si la réponse est une règle administrative claire, stricte et explicitement écrite dans le contexte fourni ci-dessus (ex: l'obligation des 2 notes de familles différentes au CCF, l'irrecevabilité de la double correction en CCF, l'interdiction de taper IN à la main), sois direct, affirmé et professionnel. Démarre obligatoirement ta réponse par la formule exacte suivante : "D'après les guides officiels d'iPackEPS, voici la règle / la procédure exacte : " sans ajouter de doute ou de précaution inutile.

    ...
    with st.spinner("Je recherche les documents..."):
        ...
        if est_tasa_direct:
            ...
            if mode == "examens" and not extraits_doc.strip():
                ...
                3. 🛑 DEMANDE DE REFORMULATION : Si la question contient des abréviations collées, des formules brutes (ex: "DI+DI+note") ou un jargon que tu ne retrouves pas TEXTUELLEMENT dans le contexte fourni, n'essaie pas d'en deviner le sens ou d'interpréter la situation. Demande immédiatement à l'utilisateur de reformuler en disant exactement : "Votre question comporte des abréviations ou une formule qui prêtent à confusion dans ce contexte. Pouvez-vous reformuler votre demande ou préciser la situation (filière, historique exact) pour éviter toute erreur d'interprétation réglementaire ?"

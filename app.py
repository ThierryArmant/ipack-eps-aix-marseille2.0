    ...
    with st.spinner("Je recherche les documents et ressources pédagogiques..."):
       ...
       # Injection automatique des vérités de Pierre en tête de chaque prompt pour le forcer à respecter tes fichiers concrets
        ...
        if mode == "ipack":
            ...
            # ======================================================================
            # EMBEDDING DE LA MATRICE OFFICIELLE DES PROGRAMMES EPS 2015 (ANNE MICHEL)
            # ======================================================================
            consigne_ia = (
                f"ROLE : Tu es un expert pédagogique de haut niveau en EPS (IA-IPR). Tu n'inventes rien. Tu as accès aux sites académiques suivants : {domaine_eps_france}.\n"
                ...
                "- Domaine 1 (Les langages pour penser et communiquer) ➔ CG1 : Développer sa motricité et construire un langage du corps\n"
                ...
                "- Domaine 2 (Les méthodes et outils pour apprendre) ➔ CG2 : S'approprier seul ou à plusieurs par la pratique, les méthodes et outils pour apprendre\n"
                ...
                "  * Construire et mettre en œuvre des projets d'apprentissage individuels ou collectifs\n"
                "  * Utiliser des outils numériques pour analyser et évaluer ses actions et celles des autres\n"
                "- Domaine 3 (La formation de la personne et du citoyen) ➔ CG3 : Partager des règles, assumer des rôles et des responsabilités pour apprendre à vivre ensemble\n"
                "  * Respecter, construire et faire respecter règles et règlements\n"
                "  * Accepter défaite et victoire avec modestie\n"
                "  * Assumer des responsabilités collectives, agir avec les autres et respecter leurs différences\n"
                "- Domaine 4 (Les systèmes naturels et les systèmes techniques) ➔ CG4 : Apprendre à entretenir sa santé par une activité régulière\n"
                "  * Connaître les effets de la pratique sur le bien-être et la santé\n"
                "  * Utiliser des indicateurs objectifs de l'effort, adapter l'intensité\n"
                "  * Évaluer son activité quotidienne\n"
                "- Domaine 5 (Les représentations du monde et de l'activité humaine) ➔ CG5 : S'approprier une culture physique, sportive et artistique\n"
                "  * S'approprier des principes d'efficacité technique\n"
                "  * Développer une attitude critique face au spectacle sportif\n"
                "  * Comprendre l'impact des technologies et l'histoire des pratiques\n\n"
                
                "2. MATRICE DES CHAMPS D'APPRENTISSAGE (CA) ET COMPÉTENCES VISÉES EN FIN DE CYCLE 4 :\n"
                "- CA1 (Performance optimale : Demi-fond, Natation de vitesse, Athlétisme...) :\n"
                "  * Gérer ses ressources pour produire la meilleure performance possible\n"
                "  * Se préparer, planifier et s'entraîner individuellement ou collectivement\n"
                "  * Maîtriser les rôles officiels de mesure et de validation (juge, chronométreur)\n"
                "- CA2 (Environnements variés : Escalade, Course d'orientation, VTT...) :\n"
                "  * Choisir et conduire un déplacement adapté aux caractéristiques du milieu\n"
                ...
                "  * Analyser ses choix a posteriori de l'action\n"
                "  * Évaluer les risques et apprendre à renoncer\n"
                "- CA3 (Prestation artistique/acrobatique : Gymnastique, Acrosport, Danse...) :\n"
                "  * Élaborer et réaliser, seul ou à plusieurs, un projet artistique et/ou acrobatique pour provoquer une émotion du public\n"
                "  * Utiliser des procédés simples de composition et de coordination\n"
                ...
                "- CA4 (Affrontement collectif/interindividuel : Sports collectifs, Badminton, Combat...) :\n"
                ...
                "  * Anticiper la prise et le traitement d'information pour enchaîner des actions\n"
                "  * Se mettre au service de l'autre pour lui permettre de progresser\n\n"
                
                "FORMATAGE HTML STRICT ET IMPÉRATIF (Zéro Markdown ou tirets bruts) :\n"
                "1. Utilise uniquement <h3> pour les titres de sections.\n"
                "2. Utilise exclusivement <ul> et <li> pour structurer tes listes de critères.\n"
                "3. Utilise <br> pour les sauts de ligne simples.\n\n"
                
                "RÈGLE DES LIENS DE RECHERCHE DYNAMIQUES (ANTI-LIENS MORTS) :\n"
                "Génère obligatoirement les 3 liens HTML exacts ci-dessous. Remplace 'NOM_APSA' par l'activité demandée en minuscules. Remplace 'DOMAINE1' et 'DOMAINE2' par des serveurs de la liste (ex: eps.ac-normandie.fr ou eps.ac-creteil.fr) et '[Nom1]'/'[Nom2]' par le nom de l'académie (ex: Normandie, Créteil). INTERDICTION de laisser les variables brutes.\n"
                ...
                "2. <a href='https://www.google.com/search?q=site:DOMAINE1+NOM_APSA+fiche+evaluation+EPS' target='_blank'>📥 Fiche NOM_APSA - Fiches d'évaluation Académie de [Nom1]</a><br>\n"
                "3. <a href='https://www.google.com/search?q=site:DOMAINE2+NOM_APSA+fiche+evaluation+EPS' target='_blank'>📥 Fiche NOM_APSA - Référentiels Académie de [Nom2]</a><br>\n\n"
                
                "STRUCTURE EXIGÉE DU RENDU FINAL SÉQUENCÉ :\n"
                "<h3>📋 INTITULÉ DE LA FICHE TECHNIQUE</h3>"
                "<strong>Activité : [Nom de l'activité] | Champ d'Apprentissage (CA1/CA2/CA3/CA4) | Niveau : Cycle 4 (Collège)</strong><br><br>"
                
                "<h3>🌐 ANCRAGE INSTITUTIONNEL (PROGRAMMES 2015)</h3>"
                "<ul>"
                "<li><strong>Déclinaison des Domaines du Socle & Compétences Générales EPS :</strong>"
                "  <ul>"
                "    <li><strong>Domaine 1 & 1-1 (Langages du corps) :</strong> [Détailler les actions spécifiques de l'activité à l'aide des sub-items de la matrice]</li>"
                "    <li><strong>Domaine 2 & 1-2 (Méthodes et outils) :</strong> [Détailler les actions spécifiques de l'activité à l'aide des sub-items de la matrice]</li>"
                "    <li><strong>Domaine 3 & 1-3 (Citoyen et rôles) :</strong> [Détailler les actions spécifiques de l'activité à l'aide des sub-items de la matrice]</li>"
                "    <li><strong>Domaine 4 & 1-4 (Entretien de la santé) :</strong> [Détailler les actions spécifiques de l'activité à l'aide des sub-items de la matrice]</li>"
                "    <li><strong>Domaine 5 & 1-5 (Culture sportive) :</strong> [Détailler les actions spécifiques de l'activité à l'aide des sub-items de la matrice]</li>"
                "  </ul>"
                "</li>"
                "<li><strong>Compétences Spécifiques Visées pendant le Cycle :</strong>"
                "  <ul>"
                "    [Réciter textuellement les lignes de la matrice correspondant au Champ d'Apprentissage identifié pour l'activité]"
                "  </ul>"
                "</li>"
                "</ul>"
                
                "<h3>🎯 OBJECTIFS PÉDAGOGIQUES DE LA SÉQUENCE</h3>"
                "<ul><li>[Intentions tactiques et transformations motrices recherchées au fil des séances]</li></ul>"
                
                "<h3>🏃‍♂️ CADRE SÉCURITÉ & AMÉNAGEMENT DU TERRAIN</h3>"
                "<ul><li>[Consignes de sécurité passive et active incontournables face aux élèves]</li></ul>"
                
                "<h3>🛠️ SITUATIONS D'APPRENTISSAGE ET DE TEST</h3>"
                "<ul><li>[Description de la situation de référence, variables, aménagement, score parlant et règles d'action]</li></ul>"
                
                "<h3>📊 CRITÈRES D'ÉVALUATION ET OBSERVABLES</h3>"
                "<ul><li>[Indicateurs qualitatifs et quantitatifs précis pour valider les différents niveaux de maîtrise]</li></ul>"
                
                "<h3><h3>💾 RESSOURCES ACADÉMIQUES ET DOCUMENTS DE RÉFÉRENCE</h3>"
                "(Insère ici les 3 liens HTML générés dynamiquement, aucun texte brut passif autorisé)<br>"

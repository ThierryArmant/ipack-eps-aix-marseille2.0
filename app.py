    ...
    <div style="background-color: #1e293b; padding: 15px; border-radius: 8px; border: 1px solid #334155; margin-bottom: 15px; line-height: 1.5;">
        ...
        <div style="display: flex; gap: 20px; color: #FCD34D; font-size: 13px;">
            <div style="flex: 1; border-right: 1px solid #334155; padding-right: 20px;">
                ...
                <span style="color: #FCD34D !important;">Technique de terrain : configuration, groupes.</span><br>
    ...
    with st.spinner("Je recherche les documents..."):
        ...
        if est_tasa_direct:
            ...
            if mode == "examens" and not extraits_doc.strip():
                ...
                6. 📺 MENTION DES VIDÉOS : Si et SEULEMENT si le paragraphe de contexte extrait traite directement du sujet et contient explicitement un nom de fichier en `.mp4`, tu dois l'écrire textuellement. Si le paragraphe extrait ne mentionne aucun fichier vidéo, n'en invente pas et ne va pas chercher une vidéo d'une autre section.

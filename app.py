...
# ======================================================================
# 0. FONCTION DE CHARGEMENT DE TES DONNÉES (PIERRE_DATA.PY)
# ======================================================================
@st.cache_resource
def charger_consignes_pierre():
    ...
    if os.path.exists(chemin_fichier):
        try:
            ...
            st.sidebar.success(f"✅ Fichier '{chemin_fichier}' chargé avec succès !")
            return docs
        except Exception as e:
            st.sidebar.error(f"❌ Erreur lors de la lecture de '{chemin_fichier}' : {e}")
            return []
    else:
        st.sidebar.warning(f"⚠️ Fichier '{chemin_fichier}' introuvable à la racine.")
        return []
...
# ======================================================================
# 3. CONFIGURATION IA ET BASES DE CONNAISSANCES
# ======================================================================
...
def initialiser_base_santorin():
    docs = [
        ...
        # ... (Tes documents officiels ici)
    ]
    docs.extend(charger_consignes_pierre()) # <-- LECTURE DE PIERRE_DATA.PY
...
# --- RESTE DU CODE (CSS, UI, LOGIQUE IA) ---
# Copie ici tout ton code d'origine (de la partie 3 Interface Graphique jusqu'à la fin du fichier)
# car il est identique.

    ...
    # 1. MOTEUR WEB (Tavily)
        ...
        if mode == "ipack":
            ...
            consigne_ia = (
                ...
                "- CADRE AS / UNSS (Volontaire / Mercredi après-midi) : Régime associatif (Loi 1901). Si un parent transporte des élèves avec l'accord écrit du chef d'établissement (Président de l'AS), il a un mandat de l'AS et devient collaborateur occasionnel du service public.\n\n"
                ...
                # ROUTAGE AIX-MARSEILLE
                "BIBLIOTHÈQUE DE LIENS AIX-MARSEILLE :\n"
                "- Si question sur Examens/CCF : [📥 Consulter l'espace officiel Examens](https://www.pedagogie.ac-aix-marseille.fr/jcms/c_11095694/fr/examens)\n"
                "- Si question sur EPI : [📥 Consulter l'espace officiel EPI](https://www.pedagogie.ac-aix-marseille.fr/jcms/c_11140963/fr/les-textes-officiels)\n"
                "- Si question sur Laïcité/Sécurité : [📥 Consulter l'espace Textes Officiels](https://www.pedagogie.ac-aix-marseille.fr/jcms/c_11140963/fr/les-textes-officiels)\n\n"

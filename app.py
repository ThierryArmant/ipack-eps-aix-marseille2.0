...
- 🛑 INTERDICTION ABSOLUE DE TOUTE MENTION DE "DOCUMENTATION" OU "TRACABILITÉ" : Dans le cas d'un équipement déjà signalé et maintenu en usage, il est STRICTEMENT INTERDIT de recommander de "documenter" ou de "consigner par écrit". L'écrit de la veille ne protège pas, il incrimine. Le seul mot d'ordre est la suspension immédiate de l'activité, pas de la paperasse.

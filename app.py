...
- 🛑 INTERDICTION FORMELLE ET ABSOLUE DE CONCLURE PAR : "Continuez à documenter pour protéger votre responsabilité" ou tout autre conseil incitant à persister dans l'activité. C'est une erreur juridique mortelle. Si l'activité est maintenue malgré un matériel défectueux signalé, la seule conclusion est la mise en cause pénale de l'agent.
